...
if __name__ == '__main__':
    ...
    setting = f'{args.model_id}_{args.data_path}_{args.model}'
    print(f"{'>'*50} Training {setting} {'<'*50}")
    exp.train(setting)
    ...
    setting = f'tmp/{args.model_id}_{args.data_path}_{args.model}'
    print(f"{'>'*50} Testing {setting} {'<'*50}")
